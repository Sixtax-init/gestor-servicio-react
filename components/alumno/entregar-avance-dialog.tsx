    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[1000px] p-0 overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-0 max-h-[85vh]">
                    {/* Columna Izquierda: Formulario */}
                    <div className="p-6 lg:p-8 flex flex-col border-b lg:border-b-0 lg:border-r border-muted-foreground/10 overflow-y-auto custom-scrollbar" style={{ maxHeight: '85vh' }}>
                    ...
                    <div className="p-6 lg:p-8 flex flex-col h-full bg-muted/5">
                        ...
                        <div className="flex-1 overflow-y-auto pr-2 space-y-3 custom-scrollbar" style={{ maxHeight: 'calc(85vh - 120px)' }}>
                            {avances.length === 0 ? (
                                ...
                                avances.map((a, idx) => (
                                    <div key={a.id} className={`group p-5 border rounded-2xl transition-all duration-300 hover:shadow-lg ${a.es_final ? 'border-primary/40 bg-primary/5 ring-1 ring-primary/20' : 'bg-card/50 border-muted-foreground/10 hover:border-primary/30 hover:bg-muted/30'}`}>
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[10px] font-black uppercase tracking-widest text-primary/70">
                                                    Avance #{avances.length - idx}
                                                </span>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {/* Comentario del Maestro (Retroalimentación) */}
                                            ...
                                            <div className="flex items-center justify-between pt-2">
                                                ...
                                                {!a.es_final && (!a.estado_entrega_principal || a.estado_entrega_principal !== 'aprobada') && (
                                                    <Button
                                                        ...
                                                        onClick={() => setShowConfirmFinal({ id: a.id, open: true })}
                                                    >
                                                        Marcar como Final
                                                    </Button>
                                                )}
